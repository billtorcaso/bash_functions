...
# This is my favorite for local use: The foreground of the separator is white text on a teal background
function setPS1()  {
...
gbr_obliterate () {
    # Instructions for how to completely annihilate a branch, locally and in the repo.
...
function awsssh()    {
    ...
    # SSH_VERBOSE == environment variable intended to carry "-v", or nothing
